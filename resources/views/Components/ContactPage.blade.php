                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subject" class="form-control mb-2" placeholder="Subject" value="{{ old('subject') }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" rows="3" class="form-control mb-2">{{ old('message') }}</textarea>
