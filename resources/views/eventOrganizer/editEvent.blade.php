...
@section('content-css')
    <link rel="stylesheet" href="./../../css/eventOrganizer/editEvent.css">
@endsection

@section('dashboard-content-title', 'Edit Event')
...
@section('dashboard-content')
    <div class="d-flex flex-row justify-content-start align-items-start mb-2" style="border: 1px solid rgba(0, 0, 0 , 0);">
        ...
        <div class="d-flex flex-column justify-content-between align-items-start" style="margin-top:24px">
